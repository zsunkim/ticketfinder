...
public interface RefundService {
	...
	List<OrderRefundShowDetail> getRefundList();
	List<OrderRefundShowDetail> getCancelOrderList();
	void modifyRefundStateSuccess(String refundOrderCode) throws RefundNotFoundException;
}
