...
public class QuestionRe {
	...
	private int questionRefRe;
	private String questionContentsRe;
	...
	public int getQuestionRefRe() {
		return questionRefRe;
	}

	public void setQuestionRefRe(int questionRefRe) {
		this.questionRefRe = questionRefRe;
	}

	public String getQuestionContentsRe() {
		return questionContentsRe;
	}

	public void setQuestionContentsRe(String questionContentsRe) {
		this.questionContentsRe = questionContentsRe;
	}
}
