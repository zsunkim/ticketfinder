				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td class="bookShow">
								<img src="${showList[s.index].tfShow.sPoster}" alt="booking">
								<p class="showTit">${showList[s.index].tfShow.sGenre} &lt;${showList[s.index].showDetail.showName}&gt;</p>
								<p class="showDate">${fn:substring(showList[s.index].tfShow.sSDate,0,10)} ~ ${fn:substring(showList[s.index].tfShow.sEDate,0,10)}</p>
								<p class="showPlace">${showList[s.index].showDetail.showHallName}</p>
							</td>
							<td class="bookDetail">
								<dl>
									<dt>예매번호</dt>
									...
									<dt>관람일</dt>
									<dd>${fn:substring(showList[s.index].showDetail.showDaytime,0,10)}</dd>
									<dt>매수</dt>
							...
							<td class="bookState">
								<p>${orderInfo.tfOrder.orderDpState}(${orderInfo.tfOrder.orderPayment})</p> <a href="${pageContext.request.contextPath}/book_detail/${orderInfo.tfOrder.orderCode}" class="btn">예매상세 +</a>
							</td>
						</tr>
						</c:forEach>
					</tbody>
