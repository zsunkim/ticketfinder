					...
					<tbody>
						...
						<tr>
							...
							<td>
	                            ...
	                            <span class="alertMessage">*영문, 숫자, 특수문자를 조합하여 6~12자까지 설정해 주세요.</span>
						...
						<tr>
							...
							<td>
								...
								<input type="text" class="iText" id="phone2" name="phone2" maxlength="4">
									<span class="hypen">-</pan>
									<input type="text" class="iText" id="phone3" name="phone3" maxlength="4">
								</div>
...
$("#joinForm").submit(function() {
	...
	//아이디 중복 검사
	var idCheck=$("#idCheckBtn").attr("value");
	if(idCheck=="N"){
	...
	var passwdReg=/^(?=.*[a-zA-Z])(?=.*[0-9])+(?=.*[~!@#$%^&*_-]).{6,12}$/g;
