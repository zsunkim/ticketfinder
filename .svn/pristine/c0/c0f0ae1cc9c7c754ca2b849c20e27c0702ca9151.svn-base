	    ...
	    <div class="banner">
	      <div class="itemBox">
	        ...
	        <div class="item" bg-color="e9e9e9">
	          <a href="${pageContext.request.contextPath}/perform_detail/PF161454/11">
	        ...
	        <div class="item" bg-color="000">
	          <a href="${pageContext.request.contextPath}/perform_detail/PF162573/41">
	            <img src="${pageContext.request.contextPath}/images/main/main_banner04.jpg" alt="미드나잇">
	          </a>
	        </div>

	        <div class="item" bg-color="000">
	          <a href="${pageContext.request.contextPath}/perform_detail/PF161865/11">
      ...
      <div class="hotBox">
        <ul>
          <li class="bigOne">  <div>${fn:substring(phone,9,13) }</div>
            <a href="${pageContext.request.contextPath}/perform_detail/${whatshot[0].tfShow.sCode}/${whatshot[0].showDetail.showArea}">
		...
		<c:forEach var="i" begin="1" end="6" step="1">
			<li class="hotList">
	            <a href="${pageContext.request.contextPath}/perform_detail/${whatshot[i].tfShow.sCode}/${whatshot[i].showDetail.showArea}">
    ...
    <div class="popBox">
      ...
      <ul>
		<c:forEach var="i" begin="3" end="8" step="1">
			<li>
	            <a href="${pageContext.request.contextPath}/perform_detail/${hotGenreList1[i].tfShow.sCode}/${hotGenreList1[i].showDetail.showArea}">
  ...
  <div class="section04">
    <div class="popBox">
      ...
      <ul>
      	<c:forEach var="i" begin="3" end="8" step="1">
			<li>
	            <a href="${pageContext.request.contextPath}/perform_detail/${hotGenreList2[i].tfShow.sCode}/${hotGenreList2[i].showDetail.showArea}">
