													...
													<c:choose>
														<c:when test="${!empty(tfOrderFclty) }">
															...
															<tr>
																...
																<td>
																	<fmt:formatNumber value="${of.tfOrder.orderPrice/of.tfOrder.orderQty }" type="number" maxFractionDigits="3"/>원
																</td>
																<td>${of.tfOrder.orderQty }</td>
																<td>${of.tfOrder.orderQty }</td>
																<td>
																	<fmt:formatNumber value="${of.tfOrder.orderPrice }" type="number" maxFractionDigits="3"/>원
																</td>
															</tr>
															</c:forEach>
														</c:when>
													...
													<c:choose>
														<c:when test="${!empty(tfRefundFclty) }">
															...
															<tr>
																...
																<td>
																	<fmt:formatNumber value="${rf.refund.refundPenalty }" type="number" maxFractionDigits="3"/>원
																</td>
																<td>
																	<fmt:formatNumber value="${rf.refund.refundPay }" type="number" maxFractionDigits="3"/>원
																</td>
															</tr>
															</c:forEach>
														</c:when>
